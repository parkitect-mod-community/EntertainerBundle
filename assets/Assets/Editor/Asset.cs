...
namespace ParkitectAssetEditor
{
    ...
    public class Asset
    {
        ...
        [JsonIgnore] public bool EnableBoundingBoxEditing;


        /// <summary>
        /// determins if the bounding box can snap
        /// </summary>
        [JsonIgnore] public bool BoundingBoxSnap;

        /// <summary>
        /// the active bounded box
        /// </summary>
        [JsonIgnore] public BoundingBox SelectedBoundingBox = null;
